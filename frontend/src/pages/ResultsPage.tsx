...
function formatVal(stat: string, val: number): string {
...
export default function ResultsPage() {
  ...
  const activeFilters: ActiveFilter[] = filtersParam ? JSON.parse(decodeURIComponent(filtersParam)) : [];
  ...
  async function handleSave(player: PlayerResult) {
    setSaving(player.id);
    try {
