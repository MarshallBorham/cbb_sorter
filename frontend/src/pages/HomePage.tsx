...
const HM_FILTER_OPTIONS: { value: string | null; label: string }[] = [
...
export default function HomePage() {
  ...
  const [hmFilter, setHmFilter] = useState<string | null>(null);
  ...
  function handleStatChange(index: number, value: string) {
  ...
  function updateAdvancedFilter(index: number, field: string, value: string) {
                ...
                <div key={index} style={{ display: "flex", alignItems: "center", gap: "0.5rem", width: "100%" }}>
                  <div className="form-group" style={{ flex: 1, marginBottom: 0, minWidth: 0 }}>
                    ...
                    <select
                      id={`stat-${index}`}
                      value={stat}
                      onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleStatChange(index, e.target.value)}
            ...
            <div className="form-group" style={{ marginBottom: "0.75rem" }}>
              <label style={{ display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer", fontFamily: MONO, fontSize: "0.72rem", letterSpacing: "0.05em", textTransform: "uppercase" }}>
                <input
                  type="checkbox"
                  checked={filterMin}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFilterMin(e.target.checked)}
                />
            ...
            <div className="form-group" style={{ marginBottom: "0.75rem" }}>
              <label style={{ display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer", fontFamily: MONO, fontSize: "0.72rem", letterSpacing: "0.05em", textTransform: "uppercase" }}>
                <input
                  type="checkbox"
                  checked={portalOnly}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setPortalOnly(e.target.checked)}
                />
            ...
            <div className="form-group" style={{ marginBottom: "0.75rem" }}>
              <label style={{ display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer", fontFamily: MONO, fontSize: "0.72rem", letterSpacing: "0.05em", textTransform: "uppercase" }}>
                <input
                  type="checkbox"
                  checked={top100}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setTop100(e.target.checked)}
                />
            ...
            <div className="form-group" style={{ marginBottom: "1rem" }}>
              <label style={{ display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer", fontFamily: MONO, fontSize: "0.72rem", letterSpacing: "0.05em", textTransform: "uppercase" }}>
                <input
                  type="checkbox"
                  checked={breakout}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setBreakout(e.target.checked)}
                />
                ...
                {advancedFilters.map((filter, index) => (
                  <div key={index} style={{ display: "flex", gap: "0.5rem", alignItems: "flex-end", width: "100%" }}>
                    <div className="form-group" style={{ flex: 2, marginBottom: 0, minWidth: 0 }}>
                      ...
                      <select
                        value={filter.stat}
                        onChange={(e: React.ChangeEvent<HTMLSelectElement>) => updateAdvancedFilter(index, "stat", e.target.value)}
                        style={{ fontFamily: MONO }}
                      >
                        {STATS.map((s) => (
                          <option key={s.value} value={s.value}>{s.label}</option>
                    ...
                    <div className="form-group" style={{ flex: 1, marginBottom: 0, minWidth: 0 }}>
                      ...
                      <select
                        value={filter.type}
                        onChange={(e: React.ChangeEvent<HTMLSelectElement>) => updateAdvancedFilter(index, "type", e.target.value)}
                        style={{ fontFamily: MONO }}
                      >
                    ...
                    <div className="form-group" style={{ flex: 1, marginBottom: 0, minWidth: 0 }}>
                      ...
                      <input
                        type="number"
                        value={filter.value}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateAdvancedFilter(index, "value", e.target.value)}
                        placeholder="0"
                        step="any"
                        style={{ fontFamily: MONO }}
                      />
